...
const getListOfCoffeeStorePhotos = async () => {
    ...
    const unsplashResults = photos.response ? photos.response.results || [];
    return unsplashResults.map((photo) =>
        photo.urls["small"]
    )
}

export async function fetchCoffeeStores(latLong = "12.932772688121572,77.60313216982671", limit = 6) {
