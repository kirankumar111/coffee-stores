...
import { handleTrackLocation } from '../hooks/use-track.location';
...
export default function Home(props) {
  ...
  const handleOnBannerClick = () => {
    ...
    { handleTrackLocation, latlong, locationErrorMsg }
  }
  return (
    <div className={ styles.container }>
      ...
      <main className={ styles.main }>
        <Banner buttonText="View shops near by" handleOnClick={ handleOnBannerClick } />
