  ...
  return (
    <div className={ styles.container }>
      ...
      <main className={ styles.main }>
        <Banner buttonText={ isFindingLocation ? "Location..." : "View shops near by" } handleOnClick={ handleOnBannerClick } />
        { locationErrorMsg ? <p>Something went wrong.</p> : "" }
        { coffeeStoresError && <p>Something went wrong</p>:{ coffeeStoresError }</p>}
      ...
      { props.coffeeStores.length > 0 && (
        <div className={ styles.sectionWrapper }>
          <h2 className={ styles.heading2 }>Stores Near My Office</h2>
          <div className={ styles.cardLayout }>
